...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/ADRES-logo.png" },                 // standard favicon
      { url: "/ADRES-logo.png", sizes: "16x16", type: "image/png" },
      { url: "/ADRES-logo.png", sizes: "32x32", type: "image/png" },
    ],
    apple: [
      { url: "/ADRES-logo.png", sizes: "180x180" },
    ],
  },
